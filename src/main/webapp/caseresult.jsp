		...
		<div id="box1">
			...
			<p>
				<input value="支社" readonly="readonly">				
					<select name="branthlist">	
							<option value="0"></option>
							<option value="1">関東支社</option>
							<option value="2">名古屋支社</option>
							<option value="3">東京支社</option>
							<option value="4">北海道支社</option>	
					</select>		
			</p>		
			<p>
				...
				<select>
					...
					<option value="2">事業部</option>
					<option value="3">財務部</option>
					<option value="4">営業部</option>
					<option value="5">情報部</option>
				</select>
			</p>
			<p>
				...
				<select>
					<option value="0"></option>
					<option value="1">営業(原価)</option>
					<option value="2">営業(見積)</option>
					<option value="3">設計・製造</option>
					<option value="4">購買</option>
				</select>
			</p>
			<p>
			...
			<p><button value=""class="check1" onclick="prevent()">検索</button></p>
			<p><input type="submit" class="check1" value="検索"></p>
		</div>
	</form>
