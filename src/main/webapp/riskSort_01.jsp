...
<body>
	<h4>リスク予防管理画面</h4>
	<form action="${pageContext.request.contextPath}/toDownList.action" method="post">
		<div id="box">
				...
				<table cellpadding="0" cellspacing="0" border="1" id="reportTbl">
					<tr>
						...
						<td class="r">
							...
							<span class="report"><input type="radio" onclick="javascript:location.href='riskSort_02.jsp'">議事録</span>
			...
			<p style="float: left;">2.&nbsp;&nbsp;リスク予防管理検討会 実施内容</p>
				<table cellpadding="0" cellspacing="0" border="1" id="reportTbl">
					<tr>
						<td class="l">発信者
							<input type="submit" value="放大镜" id="btn" >
							<a href="user.jsp"><img src="lib/pic/img.png"></a>
						</td>
						<td class="r" colspan="3">
							<input type="text" style="width: 80%;"
									value="${user.lblFullName} ${user.lblBranch } ${user.lblSect } ${user.lblPostCls }">
						</td>
					</tr>
					<tr>
						<td class="l">開催日時</td>
