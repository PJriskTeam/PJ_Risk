...
public class RiskController {
	...
	public ModelAndView toDownList(String ddlBranch_id){
		System.out.println(ddlBranch_id);
		ModelAndView mav = new ModelAndView();
		
		List<UserList> downList = riskService.getDownList(ddlBranch_id);
		for (UserList userList : downList) {
	...
	@RequestMapping("/add")
	public String add(String ddlBranch_id,String ddlBranch,String ddlDept,String txtUserCd,String txtFullName) {
		UserList  user1 = new UserList(ddlBranch_id,ddlBranch,ddlDept,txtUserCd,txtFullName);
		this.riskService.add(user1);
		return "forward:downList.do";
